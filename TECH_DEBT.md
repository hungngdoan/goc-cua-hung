...
### 8. Head metadata is bare

- No meta description, no Open Graph tags, no 404 page. Link previews when sharing the site (Zalo, Messenger, LinkedIn) show nothing. This is about link sharing, not SEO ranking.
- Fix: a few static tags in `Base.astro` plus one `og-image`.

### 9. plan-sample/DESIGN.md describes a site that was never built
...
### 10. No lint, no tests, no type checking
